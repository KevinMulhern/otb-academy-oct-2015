RSpec.describe "iterating in ruby" do
  ...
  it "can `inject` a value - and probably blow your mind" do
    ...
    # array#inject
    # Iterats over collection elements keeping track of the rest of each iteration
    # after each iteration it passes the result of the last iteration to the next
  end
